...
def get_board_url(one_regex_page_blog_url):
    '''
        ...
        :param   : one_regex_page_blog_url(str/one value of list)
...
def common_util(blogger_id, board_url):
    ...
    m_board_url = re.sub('http://', 'http://m.', BASE_URL) + blogger_id + '/' + post_num
