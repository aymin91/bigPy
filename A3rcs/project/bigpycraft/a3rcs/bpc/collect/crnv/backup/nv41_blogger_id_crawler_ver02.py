...
def regex_insert_page_num(page_num) :
    ...
    '''
    regex_page_url = BASE_URL
    regex_page_url = re.sub('currentPage=1', 'currentPage=' + str(page_num), regex_page_url)
...
def make_page_url() :
    ...
    for i in range(1, 101) :
        all_page_url.append(regex_insert_page_num(i))
...
# STEP3.
############################################################################################
def gather_blogger_info(driver, all_page_url) :
    '''
    ...
    for i in range(0, len(all_page_url)) :
        url_page = driver.get(all_page_url[i])
