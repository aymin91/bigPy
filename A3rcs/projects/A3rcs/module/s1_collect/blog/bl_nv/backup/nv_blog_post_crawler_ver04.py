...
def nick_present(board_url, content_info, blog_div, start_date, end_date) :
    ...
    if is_valid_date:
        ...
        nick_in_info['date'] = str(upload_date)
...
def nick_no_present(board_url, content_info, blog_div, start_date, end_date) :
    ...
    upload_date = util.regex_convert_date(content_info.find('p', class_='date fil5 pcol2 _postAddDate').text)  # 날짜
    ...
    if is_valid_date :
        ...
        nick_not_in_info['date'] = str(upload_date)
